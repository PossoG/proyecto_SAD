...
SECRET_KEY = 'django-insecure-5c4zez8-7#v#!sa0hxpf84frm4u8q)&vdw)tr+-%m^6@#3-f(c'
...
TEMPLATES = [
    {
        ...
        # Indicar a Django que busque plantillas en <BASE_DIR>/templates/
...
# (Opcional, descomentar en producción)
